...
export default function SideBar({
  ...
  }, [pathname, DesktopNavigation, mobileNavigation]);
            ...
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
                  ...
                  {DesktopNavigation.map((item) => (
                    <li key={item.name}>
                      <Link
                        ...
                        className={cn(
                          "group flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-primary/60 hover:bg-secondary hover:text-primary",
                          {
                            "justify-center bg-secondary text-primary":
                              item.current && closeSidebar,
                          },
                          {
                            "justify-center": closeSidebar,
                          },
                      ...
                      >
                        {item.current
                          ...
                          : item.icon(
                              "h-5 w-5 shrink-0 stroke-primary/60 group-hover:stroke-primary",
                            )}
                        <p
              ...
              <li className="mt-4 border-t border-gray-300 py-2 dark:border-secondary">
                <Link
                  href="/feed/trending"
                  className={cn(
                    "group -mx-2 flex items-center gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-primary/60 hover:bg-secondary hover:text-primary",
                    {
                      "justify-center": closeSidebar,
                    },
                  )}
                >
                  <TrendingUp className="h-5 w-5 shrink-0 stroke-primary/60 group-hover:stroke-primary" />
                  <p
                    className={cn("truncate font-semibold", {
                      hidden: closeSidebar,
                    })}
              ...
              <li className="mt-auto">
                ...
                >
                  <Settings className="h-5 w-5 shrink-0 stroke-primary/60 group-hover:stroke-primary" />
                ...
                >
                  <HelpCircle className="h-5 w-5 shrink-0 stroke-primary/60 group-hover:stroke-primary" />
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto border-gray-300 bg-background px-6 pb-4 dark:border-secondary">
                  <nav className="flex flex-1 flex-col pt-4">
                          ...
                          {mobileNavigation.map((item) => (
                            <li key={item.name}>
                              <Link
                                ...
                                className={cn(
                                  "group flex gap-x-3 rounded-md p-2 px-2 py-1.5 text-sm font-semibold leading-6 text-primary/60 hover:bg-secondary hover:text-primary",
                                  { "bg-secondary text-primary": item.current },
                                )}
                              >
                                {item.current
                    ...
                    <li className="mt-auto list-none border-b">
                      ...
                      >
                        <Lock className="h-5 w-5 shrink-0 stroke-primary/60 group-hover:stroke-primary" />
                        Privacy
                      </Link>
                      <Link
                        href="/blog/tems"
